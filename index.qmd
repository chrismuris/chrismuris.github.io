      ...
      title = colDef(
        ...
        cell = function(value, index) {
          ...
          div(
            ...
            style = "font-family: 'Roboto', sans-serif; line-height: 1.5; color: #333; padding-left: 20px; text-indent: -20px; margin-bottom: 10px;",
            ...
            div(style = "text-indent: 0px; margin-left: 0px;", btns_div)
          )
        }
      )
    ),
