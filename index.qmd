...
<img src="profile_pic.jpg" style="width: 180px; height: 180px; border-radius: 50%; object-fit: cover; border: 4px solid white; box-shadow: 0 4px 15px rgba(0,0,0,0.1); display: block;">
:::

:::{.hero-content}
<!-- CV Button (Highlighted/Elevated) -->
<div class="mb-3">
  <a href="./CV/CV_ChrisMuris.pdf" class="btn btn-primary btn-sm" target="_blank">
...
<!-- Other Links -->
:::{.profile-links}
<a href="mailto:muerisc@mcmaster.ca" class="btn btn-outline-primary btn-sm"><i class="bi bi-envelope"></i> Email</a>
<a href="https://scholar.google.com/citations?user=zh8YkR8AAAAJ&hl=en" class="btn btn-outline-primary btn-sm" target="_blank"><i class="bi bi-mortarboard"></i> Scholar</a>
<a href="https://github.com/chrismuris" class="btn btn-outline-primary btn-sm" target="_blank"><i class="bi bi-github"></i> Github</a>
<a href="https://arxiv.org/a/0000-0003-2781-3514.html" class="btn btn-outline-primary btn-sm" target="_blank"><i class="bi bi-journal-text"></i> Arxiv</a>
<a href="https://www.linkedin.com/in/chris-muris-4b5b03382" class="btn btn-outline-primary btn-sm" target="_blank"><i class="bi bi-linkedin"></i> LinkedIn</a>
<a href="https://orcid.org/0000-0003-2781-3514" class="btn btn-outline-primary btn-sm" target="_blank"><i class="bi bi-person-badge"></i> ORCID</a>
:::
:::
:::
