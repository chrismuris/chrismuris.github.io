        ...
        cell = function(value, index) {
          ...
          if (show_buttons_inline) {
            ...
            btns_row <- tags$div(
              ...
              style = "margin-top: 10px; text-indent: 0px; margin-left: 0px;",
              p_btn, pre_btn, c_btns, s_btn, ci_btn
            )
          }
          
          tags$div(
            class = "pub-citation-container",
            style = "font-family: 'Roboto', sans-serif; line-height: 1.6; color: #333; padding-left: 20px; text-indent: -20px; margin-bottom: 25px; display: block;",
            tags$div(
              style = "display: block;",
